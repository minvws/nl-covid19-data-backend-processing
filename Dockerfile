...
RUN git clone -b develop https://${PAT}:x-oauth-basic@${TBD}}/_git/DatatinoProto &&\
    git clone -b develop https://${PAT}:x-oauth-basic@${TBD}/_git/DatatinoOrchestrator &&\
    git clone -b develop https://${PAT}:x-oauth-basic@${TBD}_git/VWSPROJECTCOVID
...
RUN cd DatatinoOrchestrator && echo $' \n\
                             ...
                             flyway.locations= filesystem:DatatinoOrchestrator/sql/schemas, filesystem:DatatinoOrchestrator/sql/tables, filesystem:DatatinoOrchestrator/sql/views, filesystem:DatatinoOrchestrator/sql/stored_procedures, filesystem:DatatinoOrchestrator/sql/data' > flyway.config && \
                             ...
                             flyway.user=${USER_IN} \n\
                             flyway.password=${PASS_IN} \n\
                             flyway.schemas=VWSSTAGE, VWSSTATIC, VWSINTER, VWSDEST \n\
                             flyway.locations= filesystem:VWSPROJECTCOVID/main/sql/functions, filesystem:VWSPROJECTCOVID/main/sql/tables/VWSSTATIC, filesystem:VWSPROJECTCOVID/main/sql/tables/VWSSTAGE, filesystem:VWSPROJECTCOVID/main/sql/tables/VWSINTER, filesystem:VWSPROJECTCOVID/main/sql/tables/VWSDEST, filesystem:VWSPROJECTCOVID/main/sql/data_import/static_data, filesystem:VWSPROJECTCOVID/main/sql/views, filesystem:VWSPROJECTCOVID/main/sql/datatino_configuration/orchestration, filesystem:VWSPROJECTCOVID/main/sql/datatino_configuration/proto, filesystem:VWSPROJECTCOVID/main/sql/stored_procedures' > flyway.config
