-- 0) SCHEMAS
IF NOT EXISTS (SELECT * FROM SYS.SCHEMAS WHERE [NAME] = N'DATATINO_ORCHESTRATOR_1')
EXEC ('CREATE SCHEMA [DATATINO_ORCHESTRATOR_1] AUTHORIZATION [dbo]');
GO

IF NOT EXISTS (SELECT * FROM SYS.SCHEMAS WHERE [NAME] = N'DATATINO_PROTO_1')
EXEC ('CREATE SCHEMA [DATATINO_PROTO_1] AUTHORIZATION [dbo]');
GO
