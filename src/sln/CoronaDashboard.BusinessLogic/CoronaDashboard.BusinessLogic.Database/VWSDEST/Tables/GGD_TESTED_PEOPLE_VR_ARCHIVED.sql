CREATE TABLE [VWSDEST].[GGD_TESTED_PEOPLE_VR_ARCHIVED] (
    [ID]                                  INT             DEFAULT (NEXT VALUE FOR [dbo].[SEQ_VWSDEST_GGD_TESTED_PEOPLE_VR_ARCHIVED]) NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_GGD_TESTED_PEOPLE_VR_ARCHIVED]
    ON [VWSDEST].[GGD_TESTED_PEOPLE_VR_ARCHIVED]([DATE_OF_STATISTICS] ASC, [DATE_OF_STATISTICS_LAG] ASC, [DATE_LAST_INSERTED] ASC, [REGION_CODE] ASC)
