CREATE TABLE [VWSDEST].[GGD_TESTED_PEOPLE_VR] (
    [ID]                                  INT             DEFAULT (NEXT VALUE FOR [dbo].[SEQ_VWSDEST_GGD_TESTED_PEOPLE_VR]) NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_GGD_TESTED_PEOPLE_VR_REGION_CODE_DATE_LAST_INSERTED]
    ON [VWSDEST].[GGD_TESTED_PEOPLE_VR]([REGION_CODE] ASC, [DATE_LAST_INSERTED] ASC)
    INCLUDE([DATE_OF_STATISTICS]);


GO
CREATE NONCLUSTERED INDEX [IX_GGD_TESTED_PEOPLE_VR_REGION_CODE]
    ON [VWSDEST].[GGD_TESTED_PEOPLE_VR]([REGION_CODE] ASC)
    INCLUDE([DATE_OF_STATISTICS], [DATE_LAST_INSERTED]);


GO
CREATE NONCLUSTERED INDEX [IX_GGD_TESTED_PEOPLE_VR_DATE_LAST_INSERTED_2]
    ON [VWSDEST].[GGD_TESTED_PEOPLE_VR]([DATE_LAST_INSERTED] ASC)
    INCLUDE([DATE_OF_STATISTICS], [NEW_DATE_OF_REPORT_UNIX], [REGION_CODE], [TESTS]);


GO
CREATE NONCLUSTERED INDEX [IX_GGD_TESTED_PEOPLE_VR_DATE_LAST_INSERTED]
    ON [VWSDEST].[GGD_TESTED_PEOPLE_VR]([DATE_LAST_INSERTED] ASC)
    INCLUDE([DATE_OF_STATISTICS], [NEW_DATE_OF_REPORT_UNIX], [REGION_CODE], [PERCENTAGE_POSITIVE]);


GO
CREATE NONCLUSTERED INDEX [IX_GGD_TESTED_PEOPLE_VR]
    ON [VWSDEST].[GGD_TESTED_PEOPLE_VR]([DATE_OF_STATISTICS] ASC, [DATE_OF_STATISTICS_LAG] ASC, [DATE_LAST_INSERTED] ASC, [REGION_CODE] ASC)
