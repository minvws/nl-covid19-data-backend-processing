CREATE TABLE [VWSDEST].[GGD_TESTED_PEOPLE_BASE] (
    [ID]                                  INT             DEFAULT (NEXT VALUE FOR [dbo].[SEQ_VWSDEST_GGD_TESTED_PEOPLE_BASE]) NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_GGD_TESTED_PEOPLE_BASE_DATE_LAST_INSERTED]
    ON [VWSDEST].[GGD_TESTED_PEOPLE_BASE]([DATE_LAST_INSERTED] ASC)
...
CREATE NONCLUSTERED INDEX [IX_GGD_TESTED_PEOPLE_BASE]
    ON [VWSDEST].[GGD_TESTED_PEOPLE_BASE]([DATE_OF_STATISTICS] ASC, [DATE_OF_STATISTICS_LAG] ASC, [DATE_LAST_INSERTED] ASC, [REGION_CODE] ASC)
