...
CREATE   VIEW  VWSDEST.V_RIVM_VACCINATIONSTATUS_HOSPITAL_ADMISSIONS AS
    SELECT
    ...
    FROM  [VWSINTER].[RIVM_VACCINATIONSTATUS_HOSPITAL_ADMISSIONS]
    WHERE 
        [DATE_LAST_INSERTED] =
            (SELECT MAX(DATE_LAST_INSERTED) FROM  [VWSINTER].[RIVM_VACCINATIONSTATUS_HOSPITAL_ADMISSIONS])