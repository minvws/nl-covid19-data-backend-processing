...
CREATE    VIEW [VWSDEST].[V_DIFFERENCES_ELDERLY_AT_HOME__POSITIVE_TESTED_DAILY_VR] AS
...
WITH LAST_DATE_OF_REPORT AS (
	...
	WHERE DATE_OF_REPORT >=  '2020-02-27 00:00:00.000' --In line with elderly at home views
        AND DATE_OF_REPORT <  (SELECT MAX(DATE_OF_REPORT) FROM VWSDEST.ELDERLY_AT_HOME_VR WITH(NOLOCK)) --In line with elderly at home views. Neglect last value
