-- Copyright (c) 2020 De Staat der Nederlanden, Ministerie van   Volksgezondheid, Welzijn en Sport.
 ...
 CREATE   VIEW [VWSDEST].[V_DIFFERENCES_DISABILITY__INFECTED_LOCATIONS_TOTAL_NL_ARCHIVED_20230126] AS
 ...
 WITH LAST_DATE_OF_REPORT AS (
 	...
 	WHERE DATE_OF_REPORT >=  '2020-02-27 00:00:00.000' --In line with disability views
         AND DATE_OF_REPORT <  (SELECT MAX(DATE_OF_REPORT) FROM [VWSARCHIVE].[DISABILITY_ARCHIVED_20230126]) --In line with diability views. Neglect last value
