-- COPYRIGHT (C) 2020 DE STAAT DER NEDERLANDEN, MINISTERIE VAN   VOLKSGEZONDHEID, WELZIJN EN SPORT.
 ...
 --1) CREATE VIEW(S).....
 CREATE   VIEW [VWSDEST].[V_RIVM_VACCINATIONS_BOOSTER_SHOTS_COVERAGE_VR]
 AS
     WITH CTE AS (
         SELECT
             ...
             [PERCENTAGE],
             [PERCENTAGE_LABEL]
         FROM [VWSDEST].[RIVM_VACCINATIONS_BOOSTER_SHOTS_COVERAGE_VR] WITH(NOLOCK)
         WHERE [REGION_CODE] LIKE 'VR%'
             AND [DATE_LAST_INSERTED] = (SELECT MAX([DATE_LAST_INSERTED]) FROM  [VWSDEST].[RIVM_VACCINATIONS_BOOSTER_SHOTS_COVERAGE_VR] WITH(NOLOCK))
