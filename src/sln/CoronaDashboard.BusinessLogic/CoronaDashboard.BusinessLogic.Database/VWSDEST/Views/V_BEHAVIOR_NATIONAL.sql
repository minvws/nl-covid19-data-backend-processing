-- COPYRIGHT (C) 2020 DE STAAT DER NEDERLANDEN, MINISTERIE VAN   VOLKSGEZONDHEID, WELZIJN EN SPORT.
 ...
 CREATE   VIEW [VWSDEST].[V_BEHAVIOR_NATIONAL]
 AS
 SELECT 
     ...
     ,[dbo].[INT_TO_CHANGE]([POSTTEST_ISOLATION_COMPLIANCE_TREND]) AS [POSTTEST_ISOLATION_COMPLIANCE_TREND]	
     ,[WASH_HANDS_SUPPORT]
     ...
     ,[dbo].[INT_TO_CHANGE]([POSTTEST_ISOLATION_SUPPORT_TREND]) AS [POSTTEST_ISOLATION_SUPPORT_TREND]
