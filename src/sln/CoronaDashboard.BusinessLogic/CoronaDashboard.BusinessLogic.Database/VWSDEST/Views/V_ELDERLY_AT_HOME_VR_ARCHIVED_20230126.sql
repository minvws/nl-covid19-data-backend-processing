-- Copyright (c) 2020 De Staat der Nederlanden, Ministerie van   Volksgezondheid, Welzijn en Sport.
 ...
 CREATE   VIEW [VWSDEST].[V_ELDERLY_AT_HOME_VR_ARCHIVED_20230126]
 AS
     SELECT
     ...
     AND DATE_OF_REPORT <  (SELECT MAX(DATE_OF_REPORT) FROM [VWSARCHIVE].[ELDERLY_AT_HOME_VR_ARCHIVED_20230126] WITH(NOLOCK))
