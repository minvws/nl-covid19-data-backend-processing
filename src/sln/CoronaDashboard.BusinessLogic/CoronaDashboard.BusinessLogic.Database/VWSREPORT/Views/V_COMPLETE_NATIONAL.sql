...
CREATE   VIEW [VWSREPORT].[V_COMPLETE_NATIONAL]
AS
SELECT
    T0.*
,   INFECTED_GGD
...
,   TOTAL_TESTED_GGD
,   TESTED_GGD_AVERAGE_DATE_START
,   DATE_OF_STATISTICS AS TESTED_GGD_AVERAGE_DATE_END
...
LEFT join (
    SELECT
      ...
      ,DATE_RANGE_START AS TESTED_GGD_AVERAGE_DATE_START
      ,DATE_OF_STATISTICS AS TESTED_GGD_AVERAGE_DATE_END
