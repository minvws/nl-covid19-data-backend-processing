CREATE TABLE [VWSARCHIVE].[BEHAVIOR_PER_REGION_ARCHIVED_20221019] (
...
GO
CREATE NONCLUSTERED INDEX [IX_ARCHIVE_BEHAVIOR_PER_REGION_ARCHIVED_20221019]
    ON [VWSARCHIVE].[BEHAVIOR_PER_REGION_ARCHIVED_20221019]([DATE_LAST_INSERTED] ASC);
