...
CREATE   PROCEDURE DATATINO.UPSERT_PROTO_ITEM_SCHEDULE(
...
SET @item_id = (SELECT ID FROM DATATINO_PROTO.PROTO_CONFIGURATIONS WHERE ITEM_NAME = @item_name AND PROTO_ID = @proto_id);

IF @check_id IS NULL
INSERT DATATINO_PROTO.ITEM_SCHEDULE (WORKFLOW_ID, PROTO_ID, ITEM_ID)
VALUES (@workflow_id,
 @proto_id,
 @item_id);
ELSE
