...
CREATE   PROCEDURE DBO.SP_NURSING_HOMES_PER_REGION
AS
BEGIN
...
INSERT INTO VWSDEST.NURSING_HOMES_PER_REGION
    ...
    SELECT
		...
		,[DATE_OF_REPORTS_LAG]
		,[DATE_RANGE_START_LAG]
		,IIF(DATE_RANGE_START IS NULL, NULL, [7D_AVERAGE_TOTAL_INFECTED]) AS [7D_AVERAGE_TOTAL_INFECTED]
		,IIF(DATE_RANGE_START_LAG IS NULL, NULL, [7D_AVERAGE_TOTAL_INFECTED_LAG]) AS [7D_AVERAGE_TOTAL_INFECTED_LAG]
		,IIF(DATE_RANGE_START IS NULL, NULL, [7D_AVERAGE_TOTAL_DECEASED]) AS [7D_AVERAGE_TOTAL_DECEASED]
		,IIF(DATE_RANGE_START_LAG IS NULL, NULL, [7D_AVERAGE_TOTAL_DECEASED_LAG]) AS [7D_AVERAGE_TOTAL_DECEASED_LAG]
