...
CREATE   PROCEDURE DBO.SP_RIVM_VACCINATIONSTATUS_IC_ADMISSIONS
AS
BEGIN
    INSERT INTO VWSINTER.RIVM_VACCINATIONSTATUS_IC_ADMISSIONS
    (
       [ID]
      ,[DATE_START]
      ,[DATE_END]
    ...
    FROM 
       VWSSTAGE.RIVM_VACCINATIONSTATUS_IC_ADMISSIONS
    WHERE DATE_LAST_INSERTED = (SELECT MAX(DATE_LAST_INSERTED) from VWSSTAGE.RIVM_VACCINATIONSTATUS_IC_ADMISSIONS)
END;