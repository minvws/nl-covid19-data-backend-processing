...
CREATE   PROCEDURE DBO.SP_POSITIVE_TESTED_PEOPLE_INFECTED_DAILY_INCREASE_BASE
AS
BEGIN
...
(
  SELECT 
        ...
        CAST(ROUND([7D_AVERAGE_INFECTED_DAILY_INCREASE_ABSOLUTE],0) AS INT) AS OLD_VALUE, --reference value
        DBO.NO_NEGATIVE_NUMBER_F([INFECTED_DAILY_TOTAL]) - CAST(ROUND([7D_AVERAGE_INFECTED_DAILY_INCREASE_ABSOLUTE],0) AS INT) AS [DIFFERENCE],
...
SELECT 
        ...
        T1.[OLD_VALUE],
        -- T1.INFECTED_TOTAL AS REF_VALUE,
        [DIFFERENCE],
