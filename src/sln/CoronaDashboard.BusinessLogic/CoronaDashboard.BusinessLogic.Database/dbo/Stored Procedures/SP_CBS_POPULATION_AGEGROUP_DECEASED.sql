-- COPYRIGHT (C) 2020 DE STAAT DER NEDERLANDEN, MINISTERIE VAN   VOLKSGEZONDHEID, WELZIJN EN SPORT.
 ...
 CREATE   PROCEDURE [dbo].[SP_CBS_POPULATION_AGEGROUP_DECEASED]
 AS
 BEGIN
 ...
 SELECT 
     ...
     ,LEEFTIJD
     ,CASE 
         WHEN LEEFTIJD >= 0      AND LEEFTIJD <= 9   THEN '0-49'
         WHEN LEEFTIJD >= 10     AND LEEFTIJD <= 19  THEN '0-49'
         WHEN LEEFTIJD >= 20     AND LEEFTIJD <= 29  THEN '0-49'
         WHEN LEEFTIJD >= 30     AND LEEFTIJD <= 39  THEN '0-49'
         WHEN LEEFTIJD >= 40     AND LEEFTIJD <= 49  THEN '0-49'
 ...
 -- ORDER BY DATUM_PEILING, AGEGROUP
     ...
     INSERT INTO VWSSTATIC.CBS_POPULATION_AGEGROUP_DECEASED
     (
      [DATUM_PEILING]
     ,[AGEGROUP]
     ,[POPULATIE]
