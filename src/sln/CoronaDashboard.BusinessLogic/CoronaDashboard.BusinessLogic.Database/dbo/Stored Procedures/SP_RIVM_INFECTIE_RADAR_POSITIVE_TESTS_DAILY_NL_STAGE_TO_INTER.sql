-- COPYRIGHT (C) 2020 DE STAAT DER NEDERLANDEN, MINISTERIE VAN VOLKSGEZONDHEID, WELZIJN EN SPORT.
 ...
 CREATE   PROCEDURE [DBO].[SP_RIVM_INFECTIE_RADAR_POSITIVE_TESTS_DAILY_NL_STAGE_TO_INTER]
 AS
 BEGIN
     INSERT INTO [VWSINTER].[RIVM_INFECTIE_RADAR_POSITIVE_TESTS_DAILY_NL] (
         [VERSION],
         [DATE_OF_REPORT],
         [DATE_OF_STATISTICS],
     ...
     FROM 
         [VWSSTAGE].[RIVM_INFECTIE_RADAR_POSITIVE_TESTS_DAILY_NL]
     WHERE [DATE_LAST_INSERTED] = (SELECT MAX([DATE_LAST_INSERTED]) FROM [VWSSTAGE].[RIVM_INFECTIE_RADAR_POSITIVE_TESTS_DAILY_NL])
 END;