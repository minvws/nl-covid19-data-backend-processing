-- Copyright (c) 2020 De Staat der Nederlanden, Ministerie van Volksgezondheid, Welzijn en Sport.
 ...
 ,SECOND_CTE AS (    
	...
	,   (SUM(CAST([HOSPITALIZED] AS FLOAT)) OVER (PARTITION BY MUNICIPALITY_CODE ORDER BY DATE_OF_STATISTICS ASC ROWS BETWEEN 6 PRECEDING AND CURRENT ROW))/(T1.[INHABITANTS]/100000.0) as HOSPITALIZED_7D_PER_100000
 	FROM BASE_CTE
 	LEFT JOIN (
 ...
 SELECT
		...
		,IIF(RANK_DATE>4,HOSPITALIZED_7D,NULL) AS HOSPITALIZED_7D --apply cutoff
        ,IIF(RANK_DATE>4,HOSPITALIZED_7D_PER_100000,NULL) AS HOSPITALIZED_7D_PER_100000 --apply cutoff
 FROM RANK_TABLE
 END