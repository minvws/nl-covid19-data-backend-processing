 ...
 CREATE   PROCEDURE [dbo].[SP_ELDERLY_AT_HOME_VR_ARCHIVED_20230126] AS
 BEGIN
     TRUNCATE TABLE [VWSARCHIVE].[ELDERLY_AT_HOME_VR_ARCHIVED_20230126]
 
     INSERT INTO [VWSARCHIVE].[ELDERLY_AT_HOME_VR_ARCHIVED_20230126] (
         [ID],
         [DATE_OF_REPORT],
         [DATE_OF_REPORT_UNIX],
         [VRCODE],
     ...
     WHERE [DATE_LAST_INSERTED] = (SELECT MAX([DATE_LAST_INSERTED]) FROM [VWSDEST].[ELDERLY_AT_HOME_VR])
 END