...
IF NOT EXISTS(SELECT * FROM sys.indexes WHERE NAME='IX_DEST_HOSPITAL_ADMISSIONS_NICE_DOR')
      CREATE NONCLUSTERED INDEX IX_DEST_HOSPITAL_ADMISSIONS_NICE_DOR
      ON VWSDEST.HOSPITAL_ADMISSIONS_NICE (DATE_OF_REPORT)
      INCLUDE(DATE_OF_REPORT_UNIX, MOVING_AVERAGE_HOSPITAL, DATE_LAST_INSERTED);
GO

IF NOT EXISTS(SELECT * FROM sys.indexes WHERE NAME='IX_DEST_HOSPITAL_ADMISSIONS_NICE_DLI_DOR')
      CREATE NONCLUSTERED INDEX IX_DEST_HOSPITAL_ADMISSIONS_NICE_DLI_DOR
      ON VWSDEST.HOSPITAL_ADMISSIONS_NICE (DATE_LAST_INSERTED, DATE_OF_REPORT)
