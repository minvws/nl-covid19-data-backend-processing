...
-- Move infectious data from staging to intermediate table. 
    ...
    SELECT
        [DATE]
    ,    (CASE WHEN PREV_LOW = 'NA' THEN NULL ELSE PREV_LOW END) AS PREV_LOW
    ,    (CASE WHEN PREV_AVG = 'NA' THEN NULL ELSE PREV_AVG END) AS PREV_AVG
    ,    (CASE WHEN PREV_UP = 'NA' THEN NULL ELSE PREV_UP END) AS PREV_UP
