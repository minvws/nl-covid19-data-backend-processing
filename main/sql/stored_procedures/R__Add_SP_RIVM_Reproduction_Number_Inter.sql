...
BEGIN
    ...
    SELECT 
        [DATE],
        (CASE WHEN RT_LOW = 'NA' THEN NULL ELSE RT_LOW END) AS RT_LOW,
        (CASE WHEN RT_AVG = 'NA' THEN NULL ELSE RT_AVG END) AS RT_AVG,
        (CASE WHEN RT_UP = 'NA' THEN NULL ELSE RT_UP END) AS RT_UP
    FROM 
