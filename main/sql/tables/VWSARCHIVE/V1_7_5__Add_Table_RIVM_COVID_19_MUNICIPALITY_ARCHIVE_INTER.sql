...
IF NOT EXISTS(SELECT * FROM sys.sequences WHERE object_id = OBJECT_ID(N'[dbo].[SEQ_VWSARCHIVE_COVID19_MUNICIPALITY_ARCHIVE_INTER2]') AND type = 'SO')
CREATE SEQUENCE SEQ_VWSARCHIVE_COVID19_MUNICIPALITY_ARCHIVE_INTER2
  START WITH 1
  INCREMENT BY 1;
GO

CREATE TABLE VWSARCHIVE.RIVM_COVID_19_NUMBER_MUNICIPALITY_ARCHIVE_INTER(
	[ID] INT PRIMARY KEY NOT NULL DEFAULT (NEXT VALUE FOR [dbo].[SEQ_VWSARCHIVE_COVID19_MUNICIPALITY_ARCHIVE_INTER2]),
