...
CREATE SEQUENCE SEQ_VWSDEST_BEHAVIOR_PER_REGION
  START WITH 1
  INCREMENT BY 1;
GO

CREATE TABLE VWSDEST.BEHAVIOR_PER_REGION(
    [ID] INT PRIMARY KEY NOT NULL DEFAULT (NEXT VALUE FOR [dbo].[SEQ_VWSDEST_BEHAVIOR_PER_REGION]),
...
ON VWSDEST.BEHAVIOR_PER_REGION (DATE_LAST_INSERTED,VRCODE)
