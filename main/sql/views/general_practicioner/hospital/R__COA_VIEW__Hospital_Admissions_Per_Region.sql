...
-- Only last records are given since history is contained in results per region table.
...
SELECT
    [DATE_OF_REPORT_UNIX],
    VRCODE,
    DBO.NO_NEGATIVE_NUMBER_F(HOSPITAL_MOVING_AVG_PER_REGION) AS HOSPITAL_ADMISSIONS,
