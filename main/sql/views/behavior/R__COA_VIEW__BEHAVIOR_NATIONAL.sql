...
SELECT 
    ...
    ,   [dbo].[INT_TO_CHANGE]([SYMPTOMS_STAY_HOME_COMPLIANCE_TREND]) AS [SYMPTOMS_STAY_HOME_COMPLIANCE_TREND]
    ...
    ,   [dbo].[INT_TO_CHANGE]([SYMPTOMS_STAY_HOME_SUPPORT_TREND]) AS [SYMPTOMS_STAY_HOME_SUPPORT_TREND]
