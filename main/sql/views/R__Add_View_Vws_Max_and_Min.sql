...
CREATE VIEW [VWSDEST].[V_VWS_MAX_AND_MIN] AS
...
(SELECT MAX([RNA_PER_ML]) AS MAX_LATEST_RNA_PER_ML
       ,MIN([RNA_PER_ML]) AS MIN_LATEST_RNA_PER_ML
...
(SELECT MAX([RNA_PER_ML]) AS MAX_RNA_PER_ML
       ,MIN([RNA_PER_ML]) AS MIN_RNA_PER_ML
