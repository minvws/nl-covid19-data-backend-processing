...
CREATE OR ALTER  VIEW [VWSDEST].[V_DIFFERENCE_GGD__INFECTED_DAILY] AS
...
SELECT 
    ...
    TESTS,
	LAG(TESTS, 1, NULL) OVER (ORDER BY [NEW_DATE_OF_REPORT_UNIX]) AS [OLD_VALUE],
	TESTS -
		LAG(TESTS, 1, NULL) OVER (ORDER BY [NEW_DATE_OF_REPORT_UNIX]) AS [DIFFERENCE]
