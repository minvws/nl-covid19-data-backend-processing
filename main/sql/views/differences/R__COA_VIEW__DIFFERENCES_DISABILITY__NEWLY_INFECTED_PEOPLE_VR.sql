...
CREATE OR ALTER  VIEW [VWSDEST].[V_DIFFERENCES_DISABILITY__NEWLY_INFECTED_PEOPLE_VR] AS
...
WITH LAST_DATE_OF_REPORT AS (
	...
	WHERE DATE_OF_REPORT >=  '2020-02-27 00:00:00.000' --In line with disability views
        AND DATE_OF_REPORT <  (SELECT MAX(DATE_OF_REPORT) FROM VWSDEST.DISABILITY_VR) --In line with diability views. Neglect last value
