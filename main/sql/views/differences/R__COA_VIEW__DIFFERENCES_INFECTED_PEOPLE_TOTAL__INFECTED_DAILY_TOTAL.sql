...
CREATE OR ALTER  VIEW [VWSDEST].[V_DIFFERENCE_INFECTED_PEOPLE_TOTAL__INFECTED_DAILY_TOTAL] AS
...
SELECT 
   ...
   [7D_AVERAGE_INFECTED_DAILY_INCREASE_ABSOLUTE] AS [REF_VALUE] --contains the 7d average of absolute numbers as reference value
FROM VWSDEST.POSITIVE_TESTED_PEOPLE
