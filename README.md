...
|:---|:---|:---|:--|
|2022-04-13|[rivm_booster_shots_coverage_nl.ipynb](./src/dataflows/rivm_booster_shots_coverage_nl.ipynb)|Added additional filtering to only show data until the most recent Sunday.| <input type="checkbox" disabled checked /> Acceptance<br/><input type="checkbox" disabled /> Production|
|2022-04-13|[ecdc_cases.ipynb](./src/dataflows/ecdc_cases.ipynb)|Allow `NA-values` to be equal as `NULL-values`.| <input type="checkbox" disabled /> Acceptance<br/><input type="checkbox" disabled /> Production|
|2022-04-13|[ecdc_variants.ipynb](./src/dataflows/ecdc_variants.ipynb)|Allow `NA-values` to be equal as `NULL-values`.| <input type="checkbox" disabled /> Acceptance<br/><input type="checkbox" disabled /> Production|
