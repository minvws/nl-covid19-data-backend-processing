...
**<a style="color:red">NOTE! DUE TO TECHNICAL ISSUES THE GITHUB ACTION RUN INTO ERRORS. WE ARE TRYING TO FIX THIS AS SOON AS POSSIBLE.</a>**
...
|:---|:---|:---|:--|
|2022-04-13|[rivm_booster_shots_coverage_nl.ipynb](./src/dataflows/rivm_booster_shots_coverage_nl.ipynb)|Added additional filtering to only show data until the most recent Sunday.| <input type="checkbox" disabled checked /> Acceptance<br/><input type="checkbox" disabled checked /> Production|
|2022-04-13|[ecdc_cases.ipynb](./src/dataflows/ecdc_cases.ipynb)|Allow `NA-values` to be equal as `NULL-values`.| <input type="checkbox" disabled checked /> Acceptance<br/><input type="checkbox" disabled checked /> Production|
|2022-04-13|[ecdc_variants.ipynb](./src/dataflows/ecdc_variants.ipynb)|Allow `NA-values` to be equal as `NULL-values`.| <input type="checkbox" disabled checked /> Acceptance<br/><input type="checkbox" disabled checked /> Production|
|2022-04-20|[vws_vaccine_deliveries_administered.ipynb](./src/dataflows/vws_vaccine_deliveries_administered.ipynb)| - Automate process to directly receive data from *[VWS-Portal](vws_vaccine_deliveries_administered)*. </br> - Exclude value types `vaccine_delivery` and `vaccine_delivery_weekly` from the source and partially within the output (i.e. `vaccine_delivery` only). </br> - Replace estimated administered shots with a new (manual) workflow (i.e., *[vws_manual_input_vaccine_shots_planned.ipynb](/src/dataflows/vws_manual_input_vaccine_shots_planned.ipynb)*).| <input type="checkbox" disabled /> Acceptance<br/><input type="checkbox" disabled /> Production|
